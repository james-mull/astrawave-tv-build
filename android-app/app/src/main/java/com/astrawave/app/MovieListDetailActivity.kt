...
private fun MovieListDetailScreen(
    ...
    Column(
        ...
        when {
            loading -> AstraWaveStatePanel("Loading $title…", "Finding the best matching movies.", loading = true)
                ...
                AstraWaveFocusableCard(
                    ...
                    Row(
                        ...
                        Column(Modifier.weight(0.62f), verticalArrangement = Arrangement.spacedBy(7.dp)) {
                            ...
                            Text(
                                "Open details → Play Best, trailer, related movies, lists and source choices",
