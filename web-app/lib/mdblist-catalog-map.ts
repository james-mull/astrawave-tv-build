...
export const mdblistCatalogMap:Record<string,MdbListCatalogMapping>={
  ...
  'movie:trakt-trending-movies':{owner:'kingkearney',slug:'trakt-trending-movies'},
  'show:trakt-trending-shows':{owner:'tubeman',slug:'trakt-trending-tv-shows'},
  'movie:trakt-popular-movies':{owner:'tubeman',slug:'trakt-popular-movies'},
  'show:trakt-popular-shows':{owner:'solo_streaming',slug:'trakt-popular-shows'},
  'movie:trakt-most-watched-movies':{owner:'cb2131',slug:'emby-trakt-most-watched-movies'},
  'show:trakt-most-watched-shows':{owner:'cb2131',slug:'emby-trakt-most-watched-shows'},
  'movie:new-releases':{owner:'ndg3270',slug:'latest-movies'},
  'movie:now-playing':{owner:'solo_streaming',slug:'trakt-now-playing-movies'},
  'movie:weekend-box-office':{owner:'tubeman',slug:'trakt-weekend-box-office'},
  ...
  'movie:martial-arts':{owner:'siskourso',slug:'martial-arts-movies'},
  'movie:heist-movies':{owner:'hdlists',slug:'best-heist-movies-of-all-time'},
  'movie:spy-movies':{owner:'siskourso',slug:'spy-movies'},
  'movie:post-apocalyptic':{owner:'sysops',slug:'post-apocalyptic-si5z3eaa0g'},
  ...
  'show:japanese-series':{owner:'mattpj',slug:'top-japanese-shows'},
